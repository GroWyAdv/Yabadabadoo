...
exports.COVID19API = exports.COVID19APIAlreadyInitializedError = exports.COVID19APINotInitializedError = void 0;
var tslib_1 = require("tslib");
var COVID19APIError_1 = require("./COVID19APIError");
var FileGetter_1 = require("./DataGetter/FileGetter");
var GitHubGetter_1 = require("./DataGetter/GitHubGetter");
var DataStore_1 = require("./DataStore/DataStore");
var IndexedDBStore_1 = require("./DataStore/IndexedDBStore");
var MemoryStore_1 = require("./DataStore/MemoryStore");
var format_1 = require("./format");
var parse_1 = require("./parse");
var usLocations_1 = require("./usLocations");
/**
...
var COVID19APINotInitializedError = /** @class */ (function (_super) {
    tslib_1.__extends(COVID19APINotInitializedError, _super);
...
exports.COVID19APINotInitializedError = COVID19APINotInitializedError;
/**
 * Thrown when `init` is called more than once.
 */
var COVID19APIAlreadyInitializedError = /** @class */ (function (_super) {
    tslib_1.__extends(COVID19APIAlreadyInitializedError, _super);
...
exports.COVID19APIAlreadyInitializedError = COVID19APIAlreadyInitializedError;
/**
...
var COVID19API = /** @class */ (function () {
    function COVID19API(options) {
        ...
        switch (store) {
            case "indexeddb":
                this.dataStore = new IndexedDBStore_1.IndexedDBStore();
                break;
            case "memory":
                this.dataStore = new MemoryStore_1.MemoryStore();
        }
        switch (loadFrom) {
            case "files":
                this.dataGetter = new FileGetter_1.FileGetter(filePaths.globalConfirmedCSVPath, filePaths.globalDeathsCSVPath, filePaths.globalRecoveredCSVPath, filePaths.usConfirmedCSVPath, filePaths.usDeathsCSVPath);
                break;
            case "github":
                this.dataGetter = new GitHubGetter_1.GitHubGetter(fetch);
        }
    }
    Object.defineProperty(COVID19API.prototype, "locations", {
        ...
        get: function () {
            ...
            return tslib_1.__spreadArrays(this._locations);
        },
        enumerable: false,
        configurable: true
    });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        csv = _a.sent();
                        return [4 /*yield*/, parse_1.parseCSV(csv)];
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        dateStr = parse_1.dateToDateKey(date);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        if (e_1 instanceof DataStore_1.DataStoreInvalidLocationError) {
                            return [2 /*return*/, false];
                        }
                        throw e_1;
    ...
    COVID19API.prototype.addCalculatedValues = function (locationData) {
        var calculatedValues = locationData.values.map(function (valuesOnDate, index) {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, valuesOnDate), { newConfirmed: newConfirmed,
        ...
        return tslib_1.__assign(tslib_1.__assign({}, locationData), { values: calculatedValues });
    };
    /**
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (someStateIndex === -1) {
                            this._locations = tslib_1.__spreadArrays(this._locations, usLocations_1.US_LOCATIONS);
                        }
                        return [2 /*return*/];
                }
            });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this._firstDate = parse_1.dateKeyToDate(someGlobalLocationValues[0].date);
                        this._lastDate = parse_1.dateKeyToDate(someGlobalLocationValues[dataSetLength - 1].date);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        formattedGlobalData = format_1.formatGlobalParsedData(parsedGlobalConfirmedData, parsedGlobalDeathsData, parsedGlobalRecoveredData);
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        formattedUSData = format_1.formatUSParsedData(parsedUSConfirmedData, parsedUSDeathsData);
