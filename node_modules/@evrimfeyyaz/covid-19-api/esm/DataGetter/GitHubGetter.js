            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new DataGetterError("There was an error fetching the commit date from the GitHub API. Response status: " + response.status + " - " + response.statusText);
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        rawResponse = _a.sent();
                        if (!rawResponse.ok) {
                            throw new DataGetterError("There was an error fetching the data from GitHub. Response status: " + rawResponse.status + " - " + rawResponse.statusText);
                        }
