 ...
 */
export declare class DataStoreError extends COVID19APIError {
    constructor(message: string);
}
/**
 * Thrown when a data store instance has not been initialized by calling the `init` method first.
 */
export declare class DataStoreNotInitializedError extends DataStoreError {
    constructor();
}
/**
 * Thrown when a location cannot be found in the store.
 */
export declare class DataStoreInvalidLocationError extends DataStoreError {
