 ...
 */
var columnTitles = __assign(__assign({}, globalCSVColumnTitles), { county: "County", population: "Population" });
/**
 ...
 * @param row
 */
export function getLocationInfoFromRow(row) {
    ...
    var location = getFullLocationName(countryOrRegion, provinceOrState, county);
...
function getParserReadListener(parser, parsedCSV) {
    return function () {
        while (true) {
            ...
            var location_1 = getFullLocationName(countryOrRegion, provinceOrState, county);
 ...
 * @param parsedCSV
 */
export function getDateKeys(parsedCSV) {
